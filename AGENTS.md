...
- Every substantive agent thread should have a named work item, desired outcome, acceptance criteria, risk notes, verification plan, and final status: done, blocked, parked, or split.
